const CACHE="career-beyond-v5.20.0";
const ASSETS=["./career-beyond.html","./qc_logo_topbar.png","./qc_logo_navy.png","./manifest.json","./cb-icon-192.png","./cb-icon-512.png","./cb-faces.webp","./cb-grain.png"];
